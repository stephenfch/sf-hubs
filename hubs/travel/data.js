  ...
  trips: [
    {
      ...
      days: [
        ...
        },
        {
          ...
          date: "2026-07-25",
          weekday: "六",
          title: "Big Bang 兒童館 + 天神祭",
          location: "堺→大阪",
          hotel: "大阪北濱布萊頓酒店",
          items: [
            { time: "10:00", icon: "🚀", title: "堺市立ビッグバン (Big Bang)", desc: "大型室内兒童遊樂場，遊具の塔53m，玩到4pm左右", url: "https://www.bigbang-sakai.jp",
              info: { hours: "10:00–17:00（入館16:30止）· 月曜休 → 25/7(六)營業 ✅", mapcode: "10 556 899*37", intro: "堺市立大型児童館 Big Bang 🚀 宇宙船造型 8 層樓 🕐 10:00–17:00（入館16:30止）💴 大人¥1,000／小中¥800／幼児(3歳↑)¥600／3歳未満無料 🅿️ 第1駐車場104台(3h¥700) 🚇 泉北高速「泉ヶ丘」站步行5分 🎯 53m遊具の塔、ARフォトスポット、工作WS、昭和30年代ジオラマ", photoSpot: "遊具の塔影小朋友爬上爬落", photos: [] } },
            { time: "", icon: "🚃", title: "Big Bang → 天神祭會場", desc: "搭泉北高速→南海高野線→地下鉄堺筋線，約40min到南森町站", url: "", drive: "搭車約40min",
              info: { hours: "", mapcode: "", intro: "由泉ヶ丘站搭泉北高速→中百舌鳥轉南海高野線→天下茶屋轉地下鉄堺筋線→南森町站（天神祭會場）🚃 約40分鐘", photoSpot: "", photos: [] } },
            { time: "~15:30", icon: "🎐", title: "天神祭 本宮", desc: "日本三大祭！到會場睇陸渡御 15:30、逛逛祭典攤位", url: "https://www.tenjinmatsuri.com/",
      ...
      // =====================================================================
      // 💰 預算追蹤 — 每人單位（4大3小），¥ 計算
      // spent: 0 = 未畀／未用，>0 = 已畀／已用（可隨時 update）
      // =====================================================================
      budget: [
        { cat: "✈️ 機票（CX506+CX595 × 7人）", amount: 70000, spent: 70000, note: "已出票" },
        { cat: "🚙 租車（Times × 2 部 9日）", amount: 150000, spent: 0, note: "18/7取車時畀" },
        { cat: "⛽ 油錢・高速・泊車", amount: 60000, spent: 0, note: "ETC + 油錢 + 停車場" },
        { cat: "🏨 住宿（8晚 × 4間房）", amount: 280000, spent: 0, note: "姬路2晚+鳥取3晚+大山1晚+大阪2晚" },
        { cat: "🍽️ 飲食（7人 × 9日）", amount: 180000, spent: 0, note: "約 ¥2,800/人/日" },
        { cat: "🎫 入場・活動", amount: 50000, spent: 0, note: "花回廊¥960/人、Big Bang¥1,000/人、騎駱駝¥1,600" },
        { cat: "🎆 天神祭指定席（7張）", amount: 21000, spent: 21000, note: "B会場3列1-7番，已購" },
        { cat: "🍑 摘桃體驗", amount: 15000, spent: 0, note: "桃茂実苑 ¥1,700-2,500/人" },
        { cat: "🎁 手信・購物", amount: 70000, spent: 0, note: "藥妝、零食、紀念品" },
        { cat: "🚃 市內交通（Day8）", amount: 10000, spent: 0, note: "Big Bang→天神祭 地鐵" },
        { cat: "🛡️ 雜費・後備", amount: 30000, spent: 0, note: "便利店、雪糕、應急" },
      ],
      budgetNote: "單位：¥ · 未計兌換差價（¥100 ≈ HK$5.2）",
